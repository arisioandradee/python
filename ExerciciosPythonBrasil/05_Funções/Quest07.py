"""
7 - Faça um programa que use a função valor_pagamento para determinar o valor a ser pago
...
valor_pagamento, que calculará o valor a ser pago e devolverá este valor ao 
