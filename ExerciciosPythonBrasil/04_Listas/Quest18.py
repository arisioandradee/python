...
jogadores = [0] * 23 
while True:
    numero = int(input("Informe o número do jogador: "))
    
    if numero == 0:
        break
    
    if numero < 1 or numero > 23:
        print("Número inválido. Informe um número entre 1 e 23.")
        continue
    
    jogadores[numero - 1] += 1  

total_votos = sum(jogadores)
...
for i in range(23):
    ...
    if votos > 0:
        ...
        print(f"{i+1:>7}  -  {votos:^5}  -  {porcentagem:.2f}%")